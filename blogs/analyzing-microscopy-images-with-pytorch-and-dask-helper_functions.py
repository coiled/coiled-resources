...
def visualize_model(model, num_images=6):
    ...
    fig, axes = plt.subplots(ncols=2, nrows=images_so_far // 2, figsize=(12, 12))
    for img, pred, actual, ax in zip(images, predictions, actuals, axes.ravel()):
        imshow(img, title="Predicted: {}\nActual: {}".format(pred,actual), ax=ax)
